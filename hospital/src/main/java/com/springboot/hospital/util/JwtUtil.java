...
public class JwtUtil {
	/*
	 * In this class we need to create following methods 1. Method to Create JWT
	 * Token 2. Method to verify the Token
	 */

	private static final String secretKey = "HOS_HEX_MAY_78674867909090909090909";
	...
	public boolean verifyToken(String token, String email) {
		String extractedEmail = Jwts.parserBuilder().setSigningKey(getSigningKey()).build().parseClaimsJws(token)
				.getBody().getSubject();
